...
const TRUST = ["Fully insured & bonded", "Streak-free guarantee", "Same-day service available"];
const STATS = [
  { value: "200+", label: "Happy Clients"         },
  { value: "5.0★", label: "Avg. Rating"           },
  { value: "3+",   label: "Years in Winnipeg"     },
];
...
export default function Hero() {
  return (
    <section
      ...
      aria-label="RiseClear Property Services — Winnipeg window cleaning experts"
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl pt-28 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* Left */}
          <div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="mb-7">
            ...
            <motion.h1
              initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.65, ease: [0.22,1,0.36,1] }}
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }}
              ...
              Professional window cleaning, gutter care, pressure washing, deep cleaning, and permanent LED installation — serving{" "}
              <strong className="text-white font-semibold">Winnipeg, Manitoba</strong>{" "}with a 100% satisfaction guarantee.
            </motion.p>

            <motion.ul initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.26 }}
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.34 }}
              ...
              <a href="tel:+14318164106" className="btn-white text-[0.9375rem] px-7 py-4" aria-label="Call for a free quote">
                <Phone className="w-5 h-5" /> Call for a Free Quote
              </a>
              <Link href="/quote" className="btn-white-outline text-[0.9375rem] px-7 py-4" aria-label="Get instant estimate">
        ...
        {/* Stats bar */}
        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }}
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4 }}
        className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5" aria-hidden="true">

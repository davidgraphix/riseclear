        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <motion.div ref={imgRef} initial={{ opacity:0, x:-32, scale:0.97 }} animate={imgInView ? { opacity:1, x:0, scale:1 } : {}}
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-[0_24px_72px_rgba(14,165,233,0.14)] border border-sky-200">
              <div className="relative aspect-[4/5] bg-sky-100">
                <Image src="/images/about-team.jpeg" alt="RiseClear team member delivering professional cleaning in Winnipeg" fill className="object-cover"
          ...
          <div ref={ref} className="order-1 lg:order-2">
            ...
            <motion.p initial={{ opacity:0, y:14 }} animate={inView ? { opacity:1, y:0 } : {}} transition={{ delay:0.14 }}
              ...
              We built RiseClear on one simple idea: do the job right, treat clients with respect, and never cut corners.
            </motion.p>
            ...
            <motion.div initial={{ opacity:0, y:16 }} animate={inView ? { opacity:1, y:0 } : {}} transition={{ delay:0.7 }} className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="/quote" className="btn-sky-outline">Get Instant Estimate</a>
            </motion.div>
          </div>
        </div>
      </div>
